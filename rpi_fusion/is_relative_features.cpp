...
void ISRelativeFeatures::process_neighbor_msg(ImageData& obj, ImageData& local_scene, ImageData& neighbor_scene, 
...
std::vector<boost::asio::const_buffer> ISRelativeFeatures::make_msg(int t, int r, int c, unsigned size, std::vector<unsigned char>& image)
{
